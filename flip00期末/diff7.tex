...
\DIFdelbegin %DIFDELCMD < \DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{For example,the }\DIFaddend %%%
\DIFdelend \DIFaddbegin \DIFadd{For example,the }\DIFaddend action_type,shot_made_flag,  
